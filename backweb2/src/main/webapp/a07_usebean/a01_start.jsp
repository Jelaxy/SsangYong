...
4. 요청값 처리 기능
	...
	요청값과 지정하는 메서드 이름이 다른 때, 요청값이름으로 property를 연동할 때 param을 활용한다.
	...
	querystring이 property와 동일한 이름과 할당가능한 type으로 선언되어 있으면 자동으로 모두 다 할당하겠습니다.
