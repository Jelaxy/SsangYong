...
<%--
# jstl
1. jsp standard tag library로 사용되는 커스텀 태그를 표준으로 만든 태그 라이브러리
...
3. 위ㅇ허 같은 내용을 개선하여 jstl이라는 표준태그라이브러리를 활용하여 보다 프로그램적으로 효과적으로 처리하는 부분이 필요하여 사용하게 되었다.
4. 주요기능
	0) 환경세팅
