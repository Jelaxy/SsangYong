...
public class A02_ObjectField {
	...
	public static void main(String[] args) {
		...
		3. 메소드 : 데이터 입력, 리턴하는 데이터를 처리하는 함수
				   ...
				   // 가야할 거리를 입력받아서 필드에 저장되어 있는 연료와 함께 거리당
				   // 연료 소모량울 계산하여 갈 수 있는지 여부를 계산하여 문자열로 리턴
		*/
		Bus b1 = new Bus();
		// 참조변수.필드 = 데이터
		b1.nums = "8001";
