...
public class A10_MethodUsingAll {
	...
	public static void main(String[] args) {
		...
		// isAult(나이를 입력) 성인/미성년자는 18세 이상기준으로
		// 리턴하게 처리하세요
		System.out.println("성인여부:"+sm.isAdult(26));
		System.out.println("성인여부:"+sm.isAdult(18));
		System.out.println("성인여부:"+sm.isAdult(5));
	}
}
class ShoppingMall{
	// 입력 id, pass
