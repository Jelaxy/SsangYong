...
public class A03_StringMethod {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 주의) 배열의 길이는 배열.length 문자열의 길이 문자열.legth()
		...
		System.out.print(data.charAt(3)+"년 ");
		System.out.print(data.charAt(5));
		System.out.print(data.charAt(6)+"월 ");
		System.out.print(data.charAt(8));
		System.out.println(data.charAt(9)+"일");
